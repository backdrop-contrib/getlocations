...
*/
(function ($) {
  Backdrop.behaviors.getlocations_blocks = {
    attach: function() {

      $("#edit-getlocations-blocks-city-form-submit").click( function() {
        p = $("#edit-getlocations-blocks-city").val();
        if (p) {
          window.location = Backdrop.settings.basePath + Backdrop.settings.getlocations_blocks.city_path + '/' + p;
        }
        return false;
      });
      ...
      $("#edit-getlocations-blocks-province-form-submit").click( function() {
        ...
        if (p) {
          window.location = Backdrop.settings.basePath + Backdrop.settings.getlocations_blocks.province_path + '/' + p;
        }
        return false;
      });
      ...
      $("#edit-getlocations-blocks-postalcode-form-submit").click( function() {
        ...
        if (p) {
          window.location = Backdrop.settings.basePath + Backdrop.settings.getlocations_blocks.postalcode_path + '/' + p;
        }
        return false;
      });
      ...
      $("#edit-getlocations-blocks-country-form-submit").click( function() {
        ...
        if (p) {
          window.location = Backdrop.settings.basePath + Backdrop.settings.getlocations_blocks.country_path + '/' + p;
        }
        return false;
      });
